...
1. If the goal of the figure is to show the variation in minimum wage changes that are identifying the regression analysis that will follow, is this the *right* type of figure? Is there an alternate way of displaying this information that you think would better communicate the state-level minimum wage changes over time (or do it in a more attractive fashion)?
